          ...
          <div className="kpi" key={a.aircraft}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div className="kd up">
                ...
                {a.msn ? `MSN ${a.msn}` : 'Flotte NouvelAir'}
              </div>
            </div>
          </div>
        ))}
        ...
        <>
          <div className="g64" style={{ marginBottom: 18 }}>
            ...
            <div className="card">
              ...
              <div className="cb">
                <Bar label="OCR (pdfplumber + Tesseract + OpenCV)"    value={avgOcr}        max={100} color="var(--acc)" suffix="%" note="Précision moyenne sur docs scannés" />
                ...
                <Bar label="Déduplication SHA-256"                    value={100}            max={100} color="var(--acc)" suffix="%" note="Zéro doublon possible — empreinte unique par PDF" />
              </div>
            </div>
          </div>
            ...
            <div className="card">
              ...
              <div className="cb" style={{ padding: 12 }}>
                {!alerts?.length ? (
                  ...
                  <>
                    {alerts.map(a => (
                      <div key={a.id} className="al w" style={{ marginBottom: 8 }}>
                        <i className="fas fa-exclamation-triangle al-ic" />
                        ...
                        <span className="tag a" style={{ fontSize: 10, flexShrink: 0 }}>Attention</span>
                      </div>
                    ))}
                    {activeAlerts > 5 && (
                      <div style={{ textAlign: 'center', fontSize: 12, color: 'var(--tx3)', paddingTop: 8 }}>
                        + {activeAlerts - 5} autres alertes
                      </div>
                    )}
                  </>
                )}
            ...
            <div className="card">
              ...
              <div className="cb">
                {[
                  ...
                  { label: 'Documents à réviser',          count: needsReview,                                        ok: needsReview===0 },
                ].map((item, i) => (
